...
{
    /// <summary>
    /// Service used to create, show, and close HamkareBlazor dialogs.
    /// </summary>
    /// <remarks>
    /// Register this service and include a <see cref="HamkareDialogProvider"/> in your layout so dialogs can render and respond to close requests.
    /// </remarks>
