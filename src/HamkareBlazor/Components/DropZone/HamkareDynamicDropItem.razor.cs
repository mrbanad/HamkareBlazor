...
public partial class HamkareDynamicDropItem<T> : HamkareComponentBase where T : notnull
{
    ...
    /// <summary>
    /// At least one <see cref="HamkareDragHandle{T}"/> is registered for this item.
    ...
    /// This is suppressed when a <see cref="HamkareDragHandle{T}"/> is present so that only
    ...
    protected string Classname =>
        new CssBuilder("hamkare-drop-item")
            .AddClass("hamkare-drop-item-draggable", IsEffectivelyDraggable)
