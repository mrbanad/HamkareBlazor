...
namespace HamkareBlazor
{
    ...
    public partial class HamkareTableSortLabel<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T> : HamkareComponentBase, IDisposable
    {
        ...
        protected string Classname =>
            new CssBuilder("hamkare-table-sort-label")
                ...
                .AddClass("hamkare-table-sort-label-full-width", FullWidth)
                .AddClass(Class)
                .Build();
