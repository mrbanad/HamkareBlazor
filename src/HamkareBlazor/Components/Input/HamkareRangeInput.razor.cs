...
namespace HamkareBlazor
{
    ...
    public partial class HamkareRangeInput<T> : HamkareBaseInput<Range<T>>
    {
        ...
        /// </summary>
        public HamkareRangeInput()
        {
            Value = new Range<T>();
        }

        protected string Classname => HamkareInputCssHelper.GetClassname(this,
        ...
        {
            await _elementReferenceStart.HamkareBlurAsync();
            await _elementReferenceEnd.HamkareBlurAsync();
        }

        /// <summary>
        /// Selects the text in the starting input.
        /// </summary>
        public ValueTask SelectStartAsync() => _elementReferenceStart.HamkareSelectAsync();
        ...
        public ValueTask SelectRangeStartAsync(int pos1, int pos2) => _elementReferenceStart.HamkareSelectRangeAsync(pos1, pos2);
        ...
        /// </summary>
        public ValueTask SelectEndAsync() => _elementReferenceEnd.HamkareSelectAsync();
        ...
        /// <param name="pos1">The index of the first character to select.</param>
        /// <param name="pos2">The index of the last character to select.</param>
        public ValueTask SelectRangeEndAsync(int pos1, int pos2) => _elementReferenceEnd.HamkareSelectRangeAsync(pos1, pos2);
