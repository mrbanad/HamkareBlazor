...
$dir_utilities = $dir.Replace("tools\CssUtilitiesGenerator", "src\HamkareBlazor\Styles\utilities")
$dir_docs_utilities = $dir.Replace("tools\CssUtilitiesGenerator", "src\HamkareBlazor.Docs\Pages\CSS Utilities\AutoGenerated")
    ...
    foreach($category in $utility_categorys) {
        ...
        foreach($utility in $utilities)
        {
            ...
            $sortedClasses = $classDictonary.GetEnumerator() |
                Where-Object { -not $_.Name.StartsWith('hamkare-') } |
